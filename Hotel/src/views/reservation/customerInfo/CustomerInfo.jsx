...
const CustomerInfo = () => {
  return (
    <div>
      ...
      {/* Content */}
      <div className=" md:mx-20 font-serif p-14">
        <div className="px-10 mx-auto w-full md:px-20 ">
          {/* thẻ customer infor */}
                ...
                <div class="md:grid md:gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div className="mb-5">
                    <label class="block mb-2 text-md font-light text-gray-700 leading-3  dark:text-white">
                      Country <span className="text-red-400 font-light">*</span>
                    </label>
                    <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
